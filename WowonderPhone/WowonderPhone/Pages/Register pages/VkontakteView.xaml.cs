...
{
    public partial class VkontakteView : ContentPage
    {
        public static string HashSet = "";
        public static string Result = "false";

        public VkontakteView()
        {
            InitializeComponent();
            HashSet = RandomString(80);
            WebView1.Source = Settings.Website + "/app_api.php?application=phone&type=user_login_with&provider=Vkontakte&hash=" + HashSet;
